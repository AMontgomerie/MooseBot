...
//			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Protoss_Archon, actions.size()));
		...
		else if (r == BWAPI::Races::Terran)
		{
			...
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Vulture, actions.size()));			//12
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Machine_Shop, actions.size()));		//13
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Siege_Tank_Tank_Mode, actions.size()));		//14
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Armory, actions.size()));		//15
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Goliath, actions.size()));		//16
			...
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Science_Facility, actions.size())); //19
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Control_Tower, actions.size())); //20
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Science_Vessel, actions.size())); //21
			actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Firebat, actions.size())); //22
